...
function applyLocalFilters(items, { search, category, stockOnly, sortBy }) {
...
function buildLocalPagedResult({ safePage, safePerPage, search, category, stockOnly, sortBy }) {
  const filtered = applyLocalFilters(products, { search, category, stockOnly, sortBy })
...
export async function listProducts({
  ...
  if (API_BASE_URL) {
    try {
      ...
      return buildLocalPagedResult({ safePage, safePerPage, search, category, stockOnly, sortBy })
    }
  }
